...
ENABLE_AI_CURATION = _env_bool("ENABLE_AI_CURATION", True) and GEMINI_API_KEY is not None
...
AI_CURATION_MIN_SCORE = _env_int("AI_CURATION_MIN_SCORE", 70)
AI_CURATION_CONCURRENCY = _env_int("AI_CURATION_CONCURRENCY", 1)
AI_CURATION_MIN_INTERVAL_SECONDS = _env_float("AI_CURATION_MIN_INTERVAL_SECONDS", 13.0)
